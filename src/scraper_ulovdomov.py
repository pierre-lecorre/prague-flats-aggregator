...
class UlovDomovScraper(BaseScraper):
    ...
    base_url = "https://www.ulovdomov.cz/pronajem/bytu/praha?cena-do=20000kc&lokace=Praha"
    ...
    async def scrape(self) -> List[Dict[str, Any]]:
        ...
        async with httpx.AsyncClient(headers=headers, timeout=30) as client:
            try:
                ...
                print(f"UlovDomov scraper error: {e}")
    ...
    def parse_card(self, card) -> Dict[str, Any]:
        try:
            ...
            if url and not url.startswith('http'):
                url = "https://www.ulovdomov.cz" + url
            ...
            print(f"Error parsing UlovDomov card: {e}")
            return {}