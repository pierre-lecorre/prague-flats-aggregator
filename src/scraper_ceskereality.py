...
class CeskeRealityScraper(BaseScraper):
    ...
    base_url = "https://www.ceskereality.cz/mapa/pronajem/byty/do-20000/"
    ...
    async def scrape(self) -> List[Dict[str, Any]]:
        ...
        async with httpx.AsyncClient(headers=headers, timeout=30) as client:
            try:
                ...
                property_cards = soup.select('.property-card, .listing-item, [class*="property"], [class*="listing"]')
                ...
                print(f"CeskeReality scraper error: {e}")
    ...
    def parse_card(self, card) -> Dict[str, Any]:
        try:
            ...
            if url and not url.startswith('http'):
                url = "https://www.ceskereality.cz" + url
            ...
            print(f"Error parsing CeskeReality card: {e}")
            return {}